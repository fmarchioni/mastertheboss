...
These playbooks deploy a very basic implementation of WildFly Application Server
version 10. To use them, first edit the "hosts" inventory file to contain the
